...
<template>
    <div class="bg-white">
        ...
        <div class="relative bg-gray-800 pb-32">
            ...
            <div
                class="relative mx-auto max-w-7xl py-24 px-4 sm:py-32 sm:px-6 lg:px-8"
            >
                <h1
            ...
            >
                ...
                >
                    <div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
                        <div
                            class="bg-indigo-600 absolute top-0 inline-block -translate-y-1/2 transform rounded-xl p-5 shadow-lg"
                        >
                            <component
                                :is="link.icon"
                                aria-hidden="true"
                    ...
                    >
                        <a
                            :href="link.href"
                            class="text-indigo-700 hover:text-indigo-600 text-base font-medium"
